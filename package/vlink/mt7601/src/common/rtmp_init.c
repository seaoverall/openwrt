...
/*	{TX_RTY_CFG,			0x6bb80101},	 sample*/
	...
	{AMPDU_MAX_LEN_20M1S,		0x66655443},
	{AMPDU_MAX_LEN_20M2S,		0x77766554},
	{AMPDU_MAX_LEN_40M1S,		0x77766554},
	{AMPDU_MAX_LEN_40M2S,		0x77777665},
};
	...
	IN PRTMP_ADAPTER pAd)
{
...
#endif /* CONFIG_AP_SUPPORT */
	{
		...
		/* Update False CCA counter*/
        // sync P4 CE cl 80640 Fix False CCA Count shows zero problem when issuing cmd "iwpriv ra0 stat
...
#ifdef CONFIG_AP_SUPPORT
{
	...
	pAd->CommonCfg.PhyMode = (WMODE_B | WMODE_G| WMODE_GN);		/* default PHY mode*/
#else
