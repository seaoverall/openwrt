...
#endif
#define STA_DRIVER_VERSION			"JEDI.MP1.mt7601u.v1.9"
...
#define RT_GET_OS_PID(_x, _y)		do{rcu_read_lock(); _x=(void*)current->pids[PIDTYPE_PID].pid; rcu_read_unlock();}while(0)
