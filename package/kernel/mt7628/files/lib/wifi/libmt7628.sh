...
#
# 	ralink/MT7603/MT7610E/MT76X2E 脚本函数库
#
...
CFG_RT2860V2_MAX_BSSID=1

rt2860v2_dbg() {
      echo -n "[RT2860v2 DBG]" 	>/dev/console
      echo "$1" 			>/dev/console
}
...
ralink_shutdown_if()
{
	...
	*"2.4G")
		...
		iwpriv $vif set DisConnectAllSta=1 2>/dev/null
